...
import { Eye, EyeOff, Shield, Lock, Mail, User, KeyRound } from 'lucide-react';
import { toast } from 'sonner';

export default function AdminLogin() {
  const { login, register, firebaseLogin, isAdminAuthenticated, loading } = useAdminAuth();
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-card border border-border rounded-2xl shadow-xl p-6 md:p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3 px-4 border border-border rounded-xl bg-muted/30 hover:bg-muted/60 transition-colors text-sm font-medium disabled:opacity-50"
          >
